...
- Suter et al. 2017 (RCT, CO2 vs. Er:YAG, manufacturer-preset provenance data point): [[07 Data/Suter et al 2017 - CO2 vs Er,Cr YAG Laser Excisional Biopsy Histopathology Data]] / [[02 Literature/10.1007/s10103-017-2151-8]] — full extraction created this session; not yet incorporated into this synthesis note's manufacturer-preset-provenance sections (§6–§7, §17–§18) per this task's update-scope restriction to Parker 2024 only.
