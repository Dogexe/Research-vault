...
- FACT: The diode fiber tip was explicitly *initiated* (pre-charred) before each power setting was used — a directly stated tip-initiation protocol, useful for the vault's "initiated / non-initiated tip" parameter even though this study does not measure power loss.
