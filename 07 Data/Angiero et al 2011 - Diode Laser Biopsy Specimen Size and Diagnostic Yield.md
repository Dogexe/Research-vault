...
- HYPOTHESIS: UNKNOWN.
- Classification for this vault: the largest-sample, now full-text-verified, direct dental-diode biopsy diagnostic-yield source in this vault; central to [[04 Evidence/Biopsy Specimen Quality]] and [[04 Evidence/Surgical Margins]]. Also the first vault source with a quantified [[03 Concepts/Glossary/Thermal Damage|thermal-damage-zone]] width (260.7–321.4 μm, mean 282.8 μm) paired with a real [[03 Concepts/Glossary/Diagnostic Quality|diagnostic-yield]] outcome — relevant to [[04 Evidence/Thermal Artifact]].
