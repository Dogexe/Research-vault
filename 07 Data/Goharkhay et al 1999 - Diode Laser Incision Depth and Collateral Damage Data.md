...
**Notable: this is the first source processed in this vault's biopsy-related literature that reports genuinely measured/delivered power, not a set/console value.** The authors explicitly state the reported wattages were measured at the fiber outflow with a wattmeter and do *not* correspond to the panel/instrument display. Per vault rule, this measured value is recorded as measured output; the panel/set value is UNKNOWN because the source does not report it.
...
| Calibration method | UNKNOWN for the wattmeter itself (brand/protocol not stated beyond "measured directly... with a wattmeter") | — | — | UNKNOWN |
...
- FACT: This is the first source in this vault's biopsy-adjacent literature to report a numeric incision speed (10 mm/second), and the first to report genuinely measured (wattmeter-verified) output power rather than a set/console value.
