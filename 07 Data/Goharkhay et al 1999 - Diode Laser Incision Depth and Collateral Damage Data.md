...
**Notable: this is the first source processed in this vault's biopsy-related literature that reports genuinely [[03 Concepts/Glossary/Measured Power|measured]]/delivered power, not a [[03 Concepts/Glossary/Set Power|set]]/console value.** The authors explicitly state the reported wattages were measured at the fiber outflow with a wattmeter and do *not* correspond to the panel/instrument display. Per vault rule, this measured value is recorded as measured output; the panel/set value is UNKNOWN because the source does not report it.
