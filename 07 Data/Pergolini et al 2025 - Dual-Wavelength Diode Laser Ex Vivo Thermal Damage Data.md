...
- FACT: This is the vault's first source to vary power (2/3/4 W) and mode (CW/PW) as two independent variables in a single fully crossed design (six groups) for a dual-wavelength dental diode laser, measuring both epithelial and connective-tissue thermal damage separately. None of the pooled comparisons (mode alone, power alone) reached statistical significance at the source's own stated threshold (p ≤ 0.10) except the single Group A vs. Group B comparison noted below.
