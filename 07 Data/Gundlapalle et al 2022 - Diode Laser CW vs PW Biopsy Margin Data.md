...
- FACT: This source directly compares CW and PW diode-laser modes at the same nominal 3 W set power in a real human biopsy pathway, and found PW produced a smaller mean thermal-damage (necrotic border) width than CW (208.766 μm vs. 279.84 μm) and better pathologist-graded slide quality at both periphery and center — the vault's first source to directly compare CW vs. PW mode, at matched set power, in real human oral biopsy specimens.
