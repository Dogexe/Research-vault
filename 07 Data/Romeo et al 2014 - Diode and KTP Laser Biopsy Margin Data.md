...
- Classification for this vault: direct dental-diode biopsy diagnostic-yield and specimen-margin evidence — this vault's first source with an actual pathologist-rendered diagnosis outcome in a real human biopsy pathway, now with per-patient granularity. Relevant to [[04 Evidence/Biopsy Specimen Quality]] and [[04 Evidence/Surgical Margins]].
