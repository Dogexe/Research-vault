...
| Calibration method | [[03 Concepts/Glossary/Power Meter\|Power-meter]] check (Nova II, Ophir) performed on every device before the start of the experimental protocol — the study's own stated purpose was "to check the real emitted power," yielding the pooled 18–25% loss figure above. No [[03 Concepts/Glossary/Calibration\|calibration]] protocol for the meter itself is described. | — | Materials and methods | FACT |
...
| [[03 Concepts/Glossary/Temperature Rise\|Thermal rise]], superficial (3 W CW) | Initial 23.7±0.4 °C → final 45.1±0.9 °C; Δ 21.4±0.6 | °C | Results, Table 1 | FACT |
