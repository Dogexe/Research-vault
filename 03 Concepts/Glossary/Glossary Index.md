...
A technical glossary of standard laser/biomedical terms used across this vault's dental diode laser research. Each entry gives a concise English definition, a Thai explanation preserving the same scientific meaning, applicable formula/unit, how the term is used in this vault's own sources, and common points of confusion with neighboring terms. See individual notes for authoritative-source citations and NEEDS VERIFICATION flags.
