...
- [[06 Synthesis/Diode Laser Biopsy Specimen Quality]] — PROVISIONAL synthesis, now incorporating six processed biopsy sources after this update (added Gundlapalle et al. 2022, Pergolini et al. 2025); Capodiferro et al. 2008 and Suter et al. 2010 still have no full-text literature note in `02 Literature/` and remain unprocessed
...
- [[06 Synthesis/Diode Laser Biopsy Pre-setting Map]] — PROVISIONAL, study-level mapping table of preset/operating parameters across all six processed biopsy sources against thermal damage, carbonization, margin readability, and diagnostic quality; proposes one narrow, heavily caveated evidence-supported CW range (1.6–2.7 W, 808/980 nm, 300–320 μm fiber), explicitly not an "optimal setting"
- Note: [[04 Evidence/Biopsy Specimen Quality]], [[04 Evidence/Thermal Artifact]], and [[04 Evidence/Surgical Margins]] above have not yet been updated with Gundlapalle et al. 2022 or Pergolini et al. 2025 — per this update's scope, only the synthesis note was revised with the new evidence; these three evidence notes remain at their prior four-source state pending a future pass
...
- CONFIRMED (updated after processing): no source in this vault pairs a calibrated, independently measured dental-diode power value with a histologically assessed biopsy specimen outcome (thermal damage zone, coagulation, carbonization, diagnostic yield) in the same study — now confirmed across all six processed full-data sources (Angiero et al. 2011, Romeo et al. 2014, Azevedo et al. 2016, Gambino et al. 2026, Gundlapalle et al. 2022, Pergolini et al. 2025), which all report set/console power only.
- CONFIRMED: no source in this vault reports incision speed as an independently varied variable against specimen histologic quality; none of the six processed papers reports incision speed at all.
...
- PARTIALLY NARROWED, still unresolved: coagulation-zone evidence — Capodiferro et al. 2008 remains the only identified candidate that *scores* a coagulation zone for a dental diode laser, and remains unprocessed. Angiero et al. 2011 and Gambino et al. 2026 each describe coagulation-related histologic findings qualitatively; Gundlapalle et al. 2022 and Pergolini et al. 2025 (both newly processed) do not improve this gap either — Gundlapalle et al. describes coagulation only as a general physics mechanism, not a measured finding, and Pergolini et al. does not mention coagulation at all. See [[03 Concepts/Glossary/Coagulation Zone]].
...
Status: partially processed. Two candidates below (Gundlapalle et al., previously listed here as unprocessed; and Pergolini et al., newly identified) were processed to full text on 2026-09-12 — see [[07 Data/Gundlapalle et al 2022 - Diode Laser CW vs PW Biopsy Margin Data]] and [[07 Data/Pergolini et al 2025 - Dual-Wavelength Diode Laser Ex Vivo Thermal Damage Data]]. Capodiferro et al. and Suter et al. remain unprocessed (abstract-level review only; no literature or data-extraction notes exist for them), following the same "identified, not yet processed" convention used in [[00 Inbox/Shortlist - PubMed Candidates 3-7 (Adjacent, Not Core Diode-Output Evidence)]].

1. Capodiferro S, Maiorano E, Loiudice AM, Scarpelli F, Favia G. "Oral laser surgical pathology: a preliminary study on the clinical advantages of diode laser and on the histopathological features of specimens evaluated by conventional and confocal laser scanning microscopy." *Minerva Stomatol.* 2008;57(1-2):1-6. PMID: 18427366. (No DOI in source record.) Why flagged: n=25, diode 2–7 W; states coagulation of proteins present "only with high power density output" — directly on the power→tissue-effect link and the only identified candidate specific to [[03 Concepts/Glossary/Coagulation Zone]]. Caveat: preliminary study, abstract-level only, power appears set/nominal rather than independently measured. Still unprocessed — no full-text literature note exists in `02 Literature/`.
