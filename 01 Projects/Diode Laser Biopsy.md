...
**A10 version**
: Diode-laser treatment parameters can be selected using manufacturer-provided preset settings or manually adjusted by the operator. Preset settings can make parameter selection easier, especially for operators who have limited experience with dental lasers. However, previous studies have shown that the actual power delivered at the fiber tip may differ from the power displayed on the device, and the amount of difference can vary between laser devices. Therefore, the displayed or nominal power alone may not represent the actual amount of energy delivered to the tissue. Other factors, such as emission mode, pulse characteristics, fiber-tip condition, and the speed of fiber movement, may also affect the actual tissue exposure and the resulting tissue response.

These factors can affect both thermal tissue damage and the quality of laser-excised biopsy specimens. Thermal effects may include coagulation, carbonization, and thermal artifacts around the incision. At the same time, excessive thermal damage may affect the quality of histopathological specimens by reducing margin clarity, altering tissue architecture, or making microscopic interpretation more difficult. However, less thermal damage does not necessarily mean better specimen quality. Therefore, thermal tissue damage and histopathological specimen quality should be evaluated as separate outcomes.

Although manufacturer presets are intended to provide appropriate parameters for specific clinical procedures, there is still limited evidence on whether these preset settings provide consistent and appropriate outcomes, particularly when used by less experienced operators. Therefore, evaluating the actual laser output and its effects on thermal tissue damage and biopsy specimen quality may provide useful information for improving the understanding, reproducibility, and safety of diode-laser use in dentistry.
